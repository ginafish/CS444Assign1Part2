...
module_param(aes_key, charp, 0644);
static int aes_key_len = 16;
module_param(aes_key_len, int, 0644);
...
static void sbd_transfer(struct sbd_device *dev, sector_t sector,
    ...
    printk("sdbc.c:  sdb_transfer starting\n");
    if ((offset + nbytes) > dev->size) {
        printk (KERN_NOTICE "sbd: Beyond-end write (%ld %ld)\n", offset, nbytes);
        return;
    }
    printk("sdbc.c:  sdb_transferwas able to test beyond-end write.\n");
...
static void sbd_request(struct request_queue *q) {
    struct request *req;
    printk("sdbc.c:  sbd_request starting\n");
...
int sbd_getgeo(struct block_device * block_device, struct hd_geometry * geo) {
    long size;
    printk("sdbc.c: __init sbd_getgeo starting\n");
...
static int __init sbd_init(void) {
     ...
     */
    printk("sdbc.c: __init sdb_init setting up internel device\n");
     ...
     * Get a request queue.
     */
    printk("sdbc.c: __init sdb_init setting up request queue\n");
     ...
     * Get registered.
     */
    printk("sdbc.c: __init sdb_init setting up registration\n");
     ...
     */
    printk("sdbc.c: __init sdb_init setting up gendisk structure\n");
